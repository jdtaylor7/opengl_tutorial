...
const std::string vertex_shader_path = "src/lighting/materials/setting_materials/shader.vs";
const std::string fragment_shader_path = "src/lighting/materials/setting_materials/shader.fs";

const std::string light_source_vertex_shader_path = "src/lighting/materials/setting_materials/light_source_shader.vs";
const std::string light_source_fragment_shader_path = "src/lighting/materials/setting_materials/light_source_shader.fs";
